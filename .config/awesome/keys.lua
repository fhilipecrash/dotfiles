...
globalkeys = gears.table.join( -- Focus client by direction (arrow keys)
        ...
        group = "awesome"
    }), awful.key({modkey}, "d", function() awful.spawn("./.config/rofi/launchers/launcher.sh") end,
    ...
    -- Screen Shots/Vids
                 awful.key({}, "Print",
                            function() awful.spawn("flameshot full -p /home/fhilipe/Imagens/Screenshots/") end),
                 awful.key({modkey}, "Print",
                            function() awful.spawn.with_shell("~/.bin/shoot selnp") end),
                 awful.key({"Shift"}, "Print",
                            function() awful.spawn.with_shell("flameshot gui -p /home/fhilipe/Imagens/Screenshots/") end), 
    -- Brightness
    ...
    -- Standard program
         awful.key({modkey, "Shift"}, "a", function() awful.spawn("flatpak run com.spotify.Client") end,
                   {description = "open ncmpcpp", group = "awesome"}),
         awful.key({modkey}, "a", function() awful.spawn(music) end,
                   {description = "open ncmpcpp", group = "awesome"}),
         awful.key({modkey, "Shift"}, "q", function() awful.spawn("./scripts/picom-on-off.sh") end,
                   {description = "stop picom", group = "awesome"}),
